				...
				<div className="flex min-w-0 flex-col gap-6">
					...
					{project.status === "DRAFT" && (
						<section className="flex flex-col gap-4 rounded-xl border border-dashed border-primary/30 bg-primary/5 p-6 md:p-8">
							<h2 className="font-heading text-xl font-semibold">Begin sourcing</h2>
							<p className="max-w-prose text-sm text-muted-foreground">
								Load opening and ending themes for your selected anime. Song picks
								start once metadata is ready.
							</p>
							<Button
								size="lg"
								disabled={starting}
					...
					{!running &&
						...
						!["DRAFT", "FAILED", "CANCELLED", "COMPLETED"].includes(
							...
							<p className="text-sm text-muted-foreground">
								Automated stages are running. This view refreshes when your input is
								needed again.
							</p>
						)}
				</div>
